...
import { addSectionFn, deleteSectionFn, getHomePageDataByIdFn, getSectionListFn, updateSectionFn, updateSectionStatusFn } from "../../controllers/admin/home-page.controller";
...
export default (app: Router) => {
    ...
    app.get('/home-page-section/:section_type/:section_id', [adminAuthorization], getHomePageDataByIdFn)
