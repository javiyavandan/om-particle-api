...
import { addEditBulkPacket, addPacketFn, bulkDeletePacketFn, deleteBulkPacketFn, deletePacketFn, getAllPacketsFn, getPacketFn, updatePacketFn, updatePacketStatusBulkFn, updatePacketStatusFn } from "../../controllers/admin/packet.controller";
...
export default (app: Router) => {
    ...
    app.post("/packet-bulk-delete-csv", [adminAuthorization, reqProductBulkUploadFileParser("packet_file")], bulkDeletePacketFn)
}