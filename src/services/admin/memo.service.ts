       ...
       jsonb_set(
           ...
           to_jsonb((jsonb_array_elements(memo_details::jsonb)->>'stock_price')::double precision * ${currency})
            ...
            WHERE 
                ...
                OR memo_list.company_name LIKE '%${pagination.search_text}%'
                OR memo_list.state LIKE '%${pagination.search_text}%'
                OR memo_list.remarks LIKE '%${pagination.search_text}%'
                OR memo_list.country LIKE '%${pagination.search_text}%'
                OR memo_list.city LIKE '%${pagination.search_text}%'
                OR memo_list.customer_name LIKE '%${pagination.search_text}%'
                OR memo_list.last_name LIKE '%${pagination.search_text}%'
                OR memo_list.first_name LIKE '%${pagination.search_text}%'
                OR memo_list.registration_number LIKE '%${pagination.search_text}%'
                OR memo_list.email LIKE '%${pagination.search_text}%'
